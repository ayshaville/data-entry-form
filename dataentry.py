# CREATING A STUDENT DATA ENTRY FORM
...
def validate():
    ...
    gender= var.get()
    if (name=="" or email=="" or state== 'Select your state'or programming == 0 or gender == 0):
...
label_0 = Label(root, text="Beginners class data entry form",width=25,font=("bold", 20))
...
list1 = ['Borno','Yobe','Adaamawa','Kano','Kwara','Lagos'];
c=StringVar()
